...
import {View, Text, FlatList, RefreshControl, TouchableOpacity, Image, ScrollView, StyleSheet} from 'react-native';
...
const Pedidos_Aprovados = ({navigation, route}) => {
    ...
    return(
        <View style={styles.container}>
            ...
            <Header navigation={navigation} title="Serviço Aprovado"></Header>
            ...
            <View style={{marginBottom: 100}}>
                ...
                <View style={{flexDirection: "row", justifyContent: "center"}}>
                    <TouchableOpacity 
                        ...
                        onPress={() => navigation.navigate("Contato", {entry: entry, tela: "Pedidos_Aprovados"})}>
...
export default Pedidos_Aprovados;