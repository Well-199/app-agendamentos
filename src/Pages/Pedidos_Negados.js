...
import {View, Text, FlatList, TouchableOpacity, RefreshControl, Image, ScrollView, StyleSheet} from 'react-native';
...
const Pedidos_Negados = ({navigation, route}) => {
    ...
    return(
        <View style={styles.container}>
            ...
            <Header navigation={navigation} title="Serviço Negado"></Header>
            ...
            <View style={{marginBottom: 100}}>
                ...
                <View style={{flexDirection: "row", justifyContent: "center"}}>
                    <TouchableOpacity 
                        ...
                        onPress={() => navigation.navigate("Contato", {entry: entry, tela: "Pedidos_Negados"})}>
...
export default Pedidos_Negados;